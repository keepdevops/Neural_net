    ...
    def preview_data(self):
        ...
        try:
            ...
            try:
                ...
                # Fall back to no ordering if timestamp column doesn't exist
...
def load_data_from_duckdb(db_path=None, directory_path=None, table_name=None, feature_columns=None, label_column=None, query=None, auto_select=True):
    """Legacy wrapper for enhanced function"""
    return load_data_from_duckdb_enhanced(db_path, directory_path, table_name, feature_columns, label_column, query, auto_select)

def launch_gui_loader():
    """Legacy wrapper for enhanced GUI"""
    return launch_enhanced_gui_loader() 